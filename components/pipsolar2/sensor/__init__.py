...
CONF_NOW_TIME = "now_time"
CONF_DAILY_ELECTRICITY_GENERATION = "daily_electricity_generation"
CONF_MONTHLY_ELECTRICITY_GENERATION = "monthly_electricity_generation"
CONF_ANNUAL_ELECTRICITY_GENERATION = "annual_electricity_generation"
CONF_TOTAL_ELECTRICITY_GENERATION = "total_electricity_generation"
...
TYPES = {
    ...
    CONF_DAILY_ELECTRICITY_GENERATION: sensor.sensor_schema(
        unit_of_measurement=UNIT_KILOWATT_HOURS,
        accuracy_decimals=1,
        device_class=DEVICE_CLASS_POWER,
    ),
	CONF_MONTHLY_ELECTRICITY_GENERATION: sensor.sensor_schema(
        unit_of_measurement=UNIT_KILOWATT_HOURS,
        accuracy_decimals=1,
        device_class=DEVICE_CLASS_POWER,
    ),
	CONF_ANNUAL_ELECTRICITY_GENERATION: sensor.sensor_schema(
        unit_of_measurement=UNIT_KILOWATT_HOURS,
        accuracy_decimals=1,
        device_class=DEVICE_CLASS_POWER,
    ),
	CONF_TOTAL_ELECTRICITY_GENERATION: sensor.sensor_schema(
        unit_of_measurement=UNIT_KILOWATT_HOURS,
        accuracy_decimals=1,
        device_class=DEVICE_CLASS_POWER,
    ),
